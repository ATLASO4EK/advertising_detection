...
|-----|------|-------------------------|
| Кравченко Алексей | ML-инженер | Детекция объектов, обучение моделей |
| Христофорова Алёна | Backend-разработчик | FastAPI, Flask, Docker |
| Бикбаев Никита | Frontend / Bot Dev | Telegram-боты, клиентская логика |
| Жеребцов Никита | QA / Тестирование | Unit-тесты, интеграционное тестирование |
| Дьячкова Алёна | QA / Тестирование | Unit-тесты, интеграционное тестирование |
